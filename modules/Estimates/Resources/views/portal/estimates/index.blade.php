                ...
                <x-table>
                    <x-table.thead>
                        <x-table.tr>
                            ...
                            <x-table.th class="w-4/12" hidden-mobile>
                                ...
                                <x-slot name="first">
                                    <x-sortablelink column="expire_at"
                                                    title="{{ trans('estimates::general.expiry_date') }}"/>
                                </x-slot>
                                ...
                                <x-slot name="second">
                                    <x-sortablelink column="issued_at"
                                                    title="{{ trans('estimates::general.estimate_date') }}"/>
                                </x-slot>
                            ...
                            <x-table.th class="w-3/12 sm:table-cell">
                                ...
                                <x-sortablelink column="document_number"
                    ...
                    <x-table.tbody>
                        @foreach($estimates as $item)
                            ...
                            <x-table.tr href="{{ route('portal.estimates.estimates.show', $item->id) }}">
                                ...
                                <x-table.td class="w-3/12 hidden sm:table-cell">
                                    ...
                                    <x-index.status status="{{ $item->status }}"
                                                    background-color="bg-{{ $item->status_label }}"
                                                    text-color="text-text-{{ $item->status_label }}"/>
                                ...
                                <x-table.td class="w-3/12  sm:table-cell">
                                    ...
                                    <x-slot name="first" class="relative w-20 font-normal group"
                                            data-tooltip-target="tooltip-information-{{ $item->id }}"
                                            data-tooltip-placement="left"
                                            override="class,data-tooltip-target,data-tooltip-placement">
                                        ...
                                        <x-documents.index.information :document="$item"
                                                                       show-route="portal.estimates.estimates.show"/>
                                    </x-slot>
        ...
        @else
            ...
            <div class="flex">
                <div class="w-full text-center">
                    <div class="my-10">
                        {{ trans('estimates::portal.empty_page') }}
                    </div>
