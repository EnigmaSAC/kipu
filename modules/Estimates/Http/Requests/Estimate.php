...
class Estimate extends Document
{
    public function rules()
    {
        ...
        Arr::pull($rules, 'recurring_started_at');
        Arr::pull($rules, 'recurring_limit_date');
        ...
        $rules['status'] = 'required|string|in:draft,sent,approved,refused,expired,invoiced,viewed,cancelled';
